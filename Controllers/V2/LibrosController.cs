...
namespace WebApiAutores.Controllers.V2
{
    ...
    public class LibrosController : ControllerBase
    {
        ...
        [HttpGet("Todos", Name ="obtenerLibrosv2")]
        ...
        public async Task<ActionResult> Post([FromBody] LibroCreacionDTO libroCreacionDTO)
        {
            ...
            return CreatedAtRoute("obtenerLibrov2", new { id = libro.Id }, libroDTOAux);

            //return Ok();
        }

        [HttpPut("{id:int}", Name = "actualizarLibrov2")]
        ...
        [HttpDelete("{id:int}", Name = "borrarLibrov2")]
